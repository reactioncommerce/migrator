...
function register(program) {
  program
    ...
    .description("Unlock the track with a specific namespace. Use this when a track is reporting " +
      "being locked but you're sure nothing is actually running migrations for it right now.")
